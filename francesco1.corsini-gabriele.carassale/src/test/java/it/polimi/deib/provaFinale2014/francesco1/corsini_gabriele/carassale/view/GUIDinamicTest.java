...
public class GUIDinamicTest {
    ...
    public void testRefreshAddShepard() {
        ...
        int road = 5;
        assertFalse(gui.getRoads()[road].isIsShepard());
        
        
        gui.refreshAddShepard(1, road, true);
        assertTrue(gui.getRoads()[road].isIsShepard());
        
        //teardown test
        gui.getRoads()[road].setIsShepard(false);
    }
    ...
    public void testRefreshMoveShepard() {
        ...
        int roadto = 5;
        int idShepard = 1;
        gui.refreshAddShepard(idShepard, roadfrom, true);
        
        assertFalse(gui.getRoads()[roadto].isIsShepard());
        
        gui.refreshMoveShepard(idShepard, roadto);
        
        assertTrue(gui.getRoads()[roadto].isIsShepard());
        
        //teardown test
        gui.getRoads()[roadto].setIsShepard(false);
